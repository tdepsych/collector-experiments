...
if (typeof module !== "undefined") {
  ...
  function appropriate_message(this_message) {console.log(appropriate_message);}
} else {
  // give message to participant
  function appropriate_message(this_message) {bootbox.alert(this_message);}
}
...
/* ************************************ **  
** Action undertaken upon button clicks **
** ************************************ */
...
$("#proceed_button").on("click", function () {
  ...
  console.log("Current Page: " + current_table_no);
  console.log("Next Page: " + next_table_no);
  console.log("Total Number of Pages: " + tableCount);

  var response_elements = $("#table" + current_table_no).find(".response_element");
  ...
  console.log("Final Current Page: " + current_table_no);
  console.log("Final Next Page: " + next_table_no);
  console.log("Final Total Number of Pages: " + tableCount);
...
//from https://stackoverflow.com/questions/2116558/fastest-method-to-replace-all-instances-of-a-character-in-a-string
 ...
 */
  ...
  function clean_item(this_item) {
    if ((this_item.indexOf("'") !== -1) | (this_item.indexOf('"') !== -1)) {
      appropriate_message("Please avoid apostraphes or quote marks in the responses the participant can give. These cause problems with smooth running of surveys. This occurs when you wrote:<br><br>" +this_item);
    }
    return this_item;
  }
  ...
  function write_survey(this_survey, this_id) {
    ...
    $(".show_tab").on("click", function () {
      if (this.className.indexOf("disabled") === -1) {
        ...
        appropriate_message("You have not yet unlocked this tab - maybe try clicking on <b>Proceed</b>?");
      }
    });
  }
